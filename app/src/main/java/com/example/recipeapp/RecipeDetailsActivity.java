...
public class RecipeDetailsActivity extends AppCompatActivity {
    ...
    private final RecipeDetailsResponseListener recipeDetailsListener = new RecipeDetailsResponseListener() {
        @Override
    ...
    private final SimilarRecipeResponseListener similarRecipesListener = new SimilarRecipeResponseListener() {
        @Override
